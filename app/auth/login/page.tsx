...
export default function LoginPage() {
  ...
  // ✅ ต้องเป็นแบบนี้ — ใช้ location.origin ทุกที่
    ...
    <div className="min-h-screen flex items-center justify-center bg-zinc-950">
      <div className="w-full max-w-md bg-zinc-900 border border-zinc-800 rounded-2xl shadow-xl p-8 space-y-6">
        ...
        <div className="space-y-1">
          <h1 className="text-2xl font-semibold text-zinc-100">เข้าสู่ระบบ</h1>
          <p className="text-sm text-zinc-500">ยินดีต้อนรับกลับมาครับ</p>
        </div>
        ...
        <div className="relative">
          ...
          <div className="relative flex justify-center text-xs text-zinc-600">
            <span className="bg-zinc-900 px-3">หรือเข้าสู่ระบบด้วย</span>
          </div>
        </div>
        ...
        <div className="space-y-3">
          <button
            ...
            className="w-full bg-zinc-800 border border-zinc-700 text-zinc-200 rounded-lg py-2.5 text-sm font-medium hover:bg-zinc-700 hover:border-zinc-600 transition flex items-center justify-center gap-2"
          >
            <GoogleIcon />
        ...
        <p className="text-sm text-center text-zinc-500">
          ยังไม่มีบัญชี?{' '}
          <a href="/auth/register" className="text-zinc-200 font-medium hover:text-white transition">
            สมัครสมาชิก
          </a>
        </p>
      </div>
